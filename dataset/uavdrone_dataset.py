...
class UAVDroneDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(UAVDroneDataset, self).__init__()
        self.opt = opt
...
class UAVDroneRecurrentDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(UAVDroneRecurrentDataset, self).__init__()
        self.opt = opt
        self.gt_root, self.lq_root = Path(opt['dataroot_gt']), Path(opt['dataroot_lq'])
        self.num_frame = opt['num_frame']
