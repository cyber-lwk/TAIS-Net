...
from basicsr.utils.attention import CrossAttention
...
# 实现了基于正弦函数的位置编码，用于在注意力机制中引入位置信息。
...
# 基本的 Transformer 块，包含自注意力和交叉注意力。
