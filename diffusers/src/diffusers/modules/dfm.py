...
from diffusers.modules.sync_batchnorm import SynchronizedBatchNorm2d
bn_mom = 0.0003
...
if __name__ == '__main__':
    ...
    net = DF_Module(256,256)
    net = net.to(device)

    x= torch.randn(8,256,32,32).to(device)
    y = torch.randn(8,256,32,32).to(device)
